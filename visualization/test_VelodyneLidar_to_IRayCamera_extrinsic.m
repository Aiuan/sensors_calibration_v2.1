...
%% VelodyneLidar_to_LeopardCamera0_extrinsic, IRayCamera_to_LeopardCamera0_extrinsic
figure();
...
for i = 1:length(labels)
    ...
    tform = rigidtform3d(invert(IRayCamera_to_LeopardCamera0_extrinsic).A * ...
        VelodyneLidar_to_LeopardCamera0_extrinsic.A);
    [uv, ~]= projectLidarPointsOnImage(pointCloud(bbox'), ...
        IRayCamera_intrinsic, tform);
    uv = uv';
