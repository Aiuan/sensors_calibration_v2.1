...
%% VelodyneLidar_to_LeopardCamera0_extrinsic, LeopardCamera1_to_LeopardCamera0_extrinsic
figure();
...
for i = 1:length(labels)
    ...
    tform = rigidtform3d(invert(LeopardCamera1_to_LeopardCamera0_extrinsic).A * ...
        VelodyneLidar_to_LeopardCamera0_extrinsic.A);
    [uv, ~]= projectLidarPointsOnImage(pointCloud(bbox'), ...
        LeopardCamera1_intrinsic, tform);
    uv = uv';
